...
def get_initial_page(fpage, config, pipeline_docs_html, lgb_table, logreg_table, knn_table, ann_table):
  #where is fpage template?
...
def get_data(form_data, fpage, config, fitted_transformer, ann_model, knn_model, logreg_model,lgb_model, lime_explainer ):
  #get predictions
  def ann_proba(rows):
